...
!!! TALK ABOUT HOW TO HANDLE THE X-CHROM !!!
...
```{r echo=FALSE, warning=FALSE}
ggplot(biallele.novel.counts.singleton)  + geom_freqpoly(aes(x=delta_bp, color=group), bins=10)  + theme_clear() + scale_x_continuous(limits=c(-4,7), breaks =seq(-3,6,2))+ labs(x="Nucleotides Inserted/Deleted", y="Number of Sites", title="INDEL Count by Size (Novel Singletons)")
